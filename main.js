...
//
//             let buttUserInfo = document.createElement('button');
//             button.innerText = 'More info';
//
//             buttUserInfo.onclick = function () {
//
//
//             }
//
//             button.onclick='user-details.html?data=' + JSON.stringify(user);
//
//
//             a.href = 'user-details.html?data=' + JSON.stringify(user);
//
//             divUserBlock.appendChild(h1);
